					...
					<td>
						<fieldset>
							...
							<label for="automattic_wordpress_email">
								<input name="automattic_wordpress_email" type="checkbox" id="automattic_wordpress_email" value="true" <?php checked('true', get_option('acui_automattic_wordpress_email')); ?>>
