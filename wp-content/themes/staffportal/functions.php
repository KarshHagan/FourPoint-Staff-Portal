...
class Fourpoint {
	...
	function init_assets() {
		if (!is_admin() & !is_login_page()) {
			// STYLES
			wp_enqueue_style($this->theme_name . '-styles', get_bloginfo('stylesheet_directory') . '/assets/build/style.css', false, $this->scripts_version, 'all');
			...
			wp_enqueue_script('nav', get_bloginfo('stylesheet_directory') . '/assets/build/staff-portal.js', array('jquery'), $this->scripts_version, true);
		}
	}
